...
We created the `sedtR` package to allow R programmers to easily interact with Urban's Spatial Equity Data Tool (SEDT) application programming interface (API). 
