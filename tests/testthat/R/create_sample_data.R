create_sample_data <- function(){
  ...
  write_csv(geo_county, "data/test_api_geo_county.csv")

  # both geographic and demographic for county is at tract level, so use same data
  write_csv(geo_county, "data/test_api_dem_county.csv")
  ...
  write_csv(geo_state, "data/test_api_geo_state.csv")
  ...
  write_csv(geo_national, "data/test_api_geo_national.csv")
  ...
  write_csv(dem_state, "data/test_api_dem_state.csv")
  ...
  write_csv(dem_national, "data/test_api_dem_national.csv")
  ...
  write_csv(wa_mental_health, "data/wa_mental_health.csv")
