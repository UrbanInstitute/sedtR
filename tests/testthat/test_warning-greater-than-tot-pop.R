test_that("Warn about columns with population larger than tot_pop", {
  ...
  param_list <- list(
    ...
    geo = "city",
    acs_data_year = "2019",
    demographic_file_path = here::here("tests", "testthat", "data", "demographic_above_tot_pop_33.csv"),
    ...
    geographic_file_path = here::here("tests", "testthat", "data", "geographic_above_tot_pop_33.csv"),
  ...
  #Check none dropped:
  testthat::expect_identical(list(), sedt_status[["results"]][["formdata"]][["warnings"]][["demographic_dropped_over_half_values_greater_than_total_pop"]])
  testthat::expect_identical(list(), sedt_status[["results"]][["formdata"]][["warnings"]][["geographic_dropped_over_half_values_greater_than_total_pop"]])
})
